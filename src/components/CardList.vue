...
onMounted(() => {
    videoid.value = props.cardData.id
    cover.value = props.cardData.cover
    title.value = props.cardData.title
    avatar.value = props.cardData.author.userinfo.avatar
    username.value = props.cardData.author.userinfo.username
    userid.value = props.cardData.author.userinfo.id
...
const view = computed(() => {
    return dataSet(props.cardData.count.count_view)
})

const like = computed(() => {
    return dataSet(props.cardData.count.count_like)
})

const du = computed(() => {
    return duration(props.cardData.duration)
})
